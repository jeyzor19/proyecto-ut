...
const { marcarComoCompletado, eliminarProyecto, obtenerProyectosEliminados, reactivarProyecto, crearBitacoraSimple, listarBitacoras } = require('../controllers/proyecto.controller');
...
router.post('/bitacoras', crearBitacoraSimple);
router.get('/bitacoras/proyecto/:idProyecto', listarBitacoras);
